...
import { StyleSheet, Button, Text, View, Picker, ScrollView, Platform, AppRegistry } from 'react-native';
...
AppRegistry.registerComponent("LocalizationScreen", () => LocalizationScreen);
